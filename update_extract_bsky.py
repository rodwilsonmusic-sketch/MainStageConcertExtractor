...
path = "/Volumes/Music1/GeminiProjects/ConcertExtractorUtility/extract_bsky_upgraded.py"
with open(path, "r") as f:
    text = f.read()

# Replace JS formatting for shift with explicit arrays for the steppedKnobs
# Replace variations with updated knobs
# Ensure flipswitches exist correctly in the output
...
def extract_bigsky():
    ...
    for idx, engine in enumerate(engines):
        ...
        # Assemble panels. 
        # The user was clear: "When he fixes the 2 Row orietation, the Knobs should be the same size as the Top Row"
        # Since panels are structurally flat arrays of Panel objects on the Page:
        panel_list = [top_row, bottom_row] + clusters + [preset_row]
